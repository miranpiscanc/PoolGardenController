...
def load_houses_metadata():
    ...
    return [house.to_public_dict() for house in house_registry.all()]
...
def opicina_dashboard():
    context = current_house_context("opicina")
    house = context.to_public_dict() if context else DEFAULT_HOUSES[1]
