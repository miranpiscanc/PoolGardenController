...
function renderViewer(data) {
  ...
  safeRender('energy', () => renderEnergy(data.energy || {}));
  safeRender('pool', () => renderPool(data.pool || {}, data.temperatures || {}));
  safeRender('heater', () => renderHeater(data.heater || {}));
  ...
  safeRender('solar', () => renderSolar(data.solar_heating || {}));
  safeRender('garden', () => renderGarden(data.garden || {}));
  safeRender('statistics', () => renderStatistics(data.statistics || {}));
